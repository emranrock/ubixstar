        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>admin/blog/"><i class="fa fa-plus"></i> Add
                        New</a>
                </div>
            </div>
                ...
                <div class="box">
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><?php echo substr($record->description,0,25).'...'; ?></td>
                                    <td><?php echo substr($record->body,0,50).'...'; ?></td>
                                    <td><?php echo $record->date; ?></td>
                                   
                                    <td><?php echo $record->status; ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-info"
                                            href="<?php echo base_url().'admin/blog/edit/'.encode_url($record->id); ?>" 
