...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/blog/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
               ...
               <textarea name="body" class="form-control editors"  rows="5"><?php echo $body; ?></textarea>
               <!-- <p class="help-block">Message Limit is 150 Characters</p> -->
            </div>
