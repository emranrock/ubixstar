...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/testimonials/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <?php } else{ ?>
                <div class="default">
                <img src="<?php echo base_url().'uploads/front/testimonials/'.$image;?>" class="img-thumbnail" width="30%" height="30%"/>
