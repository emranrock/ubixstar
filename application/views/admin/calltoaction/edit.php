...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
      <h2>
        <i class="fa fa-users"></i> Edit Call To Action
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/calltoaction/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <input type="text" id="short_description" name="short_description" class="form-control" value="<?php echo $description; ?>">

            </div>
            <div class="form-group">
              <label for="exampleInputFile">Button Text</label>
              <input type="text" id="btn_text" name="btn_text" class="form-control" value="<?php echo $link; ?>">
            </div>
