...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
      <h2>
        <i class="fa fa-users"></i> Edit Brands Image
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/brands/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <?php } else{ ?>
                <div class="default">
                <img src="<?php echo base_url().'uploads/front/brands/'.$image;?>" class="img-thumbnail" width="30%" height="30%"/>
