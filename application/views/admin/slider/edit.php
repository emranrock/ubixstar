...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
      <h2>
        <i class="fa fa-users"></i> Edit Slider
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url('admin/slider/edit');?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sub_title" class="form-control" value="<?php echo $sub_title; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <?php } else{ ?>
                <div class="default">
                <img src="<?php echo base_url().'uploads/front/slider/'.$image;?>" class="img-thumbnail" width="50%" height="50%"/>
