        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('admin/services/'); ?>"><i class="fa fa-plus"></i> Add
                        New</a>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo substr($record->desciption, 0, 25) . '...'; ?></td>
                                            <td><?php echo $record->status; ?></td>
                                            <td>
                                                <a class="btn btn-sm btn-info" href="<?php echo base_url('admin/services/edit/') . $record->id; ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
