...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
      <h2>
        <i class="fa fa-users"></i> Edit Skills
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/skills/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <input type="number" name="percentage" class="form-control" value="<?php echo $percentage;?>">
