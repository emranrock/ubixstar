...
<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/services_page" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
               ...
               <textarea name="description" class="form-control editors"  rows="5"></textarea>
