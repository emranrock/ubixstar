...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form action="<?php echo base_url();?>admin/services_page/edit" method="post" enctype="multipart/form-data">
        <div class="box-body">
            <div class="col-md-8">
            ...
            <div class="form-group">
               ...
               <textarea name="description" class="form-control editors"  rows="5">"<?php echo $description;?></textarea>
            ...
            <div class="form-group">
                ...
                <?php } else{ ?>
                <div class="default">
                <img src="<?php echo base_url().'uploads/front/services/'.$image;?>" class="img-thumbnail" width="50%" height="50%"/>
